...
((findDisplay 5200) displayCtrl 3) ctrlAddEventHandler["ButtonClick", {
    ...
    closeDialog 0;
    [format["<t size='1' align='center' shadow='2' font='PuristaMedium'>Neony dodane, naciśnij SHIFT-J aby je włączyć <br/><t color='#12FE00'>$%1</t> left</t>", [gl_cash] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
}];
((findDisplay 5200) displayCtrl 4) ctrlAddEventHandler["ButtonClick", {
    ...
    gl_cash = gl_cash + mav_tuning_rgbprice;
    [format["<t size='1' align='center' shadow='2' font='PuristaMedium'><t color='#12FE00'>$%1</t> zostało Ci zwrócone. Masz teraz <br/><t color='#12FE00'>$%2</t> left</t>", [mav_tuning_rgbprice] call BIS_fnc_numberText, [gl_cash] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
}];
