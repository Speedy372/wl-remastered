...
AND _class == "Colors") exitWith {
    ...
    gl_cash = gl_cash - _price;
    mav_tuning_rgbprice = _price;
    [format["<t size='1' align='center' shadow='2' font='PuristaMedium'>Kupiłeś ulepszenie za <t color='#12FE00'>$%1</t><br/>Zostało Ci <t color='#12FE00'>$%2</t></t>", [mav_tuning_rgbprice] call BIS_fnc_numberText, [gl_cash] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
...
if (true) then {
    ...
    gl_cash = gl_cash - _price;
    [format["<t size='1' align='center' shadow='2' font='PuristaMedium'>Kupiłeś ulepszenie za <t color='#12FE00'>$%1</t><br/>Zostało Ci <t color='#12FE00'>$%2</t></t>", [_price] call BIS_fnc_numberText, [gl_cash] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
    _ctrl lbSetCurSel - 1;
};