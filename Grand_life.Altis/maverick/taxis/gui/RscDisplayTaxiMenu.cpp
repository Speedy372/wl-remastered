class RscDisplayTaxiMenu {
    ...
    class Controls {
        ...
        class FirstButton: MAV_ctrlButton {#define BUTTON_HEIGHT 10#define BUTTON_WIDTH(DIALOG_W - DIALOG_PADDING * 2 - 12)
        ...
        class SecondButton: MAV_ctrlButton {#define BUTTON_HEIGHT 10#define BUTTON_WIDTH(DIALOG_W - DIALOG_PADDING * 2 - 12)
        ...
        class ThirdButton: MAV_ctrlButton {#define BUTTON_HEIGHT 10#define BUTTON_WIDTH(DIALOG_W - DIALOG_PADDING * 2 - 12)
