...
case "onLoad":
    {
        ...
        _btnDriver ctrlAddEventHandler["ButtonClick", {
            ["btnDriverClicked", _this] call RscDisplayTaxiMenu
        }];
        private _btnCustomer = _display displayCtrl MAV_IDC_RSCDISPLAYTAXIMENU_CUSTOMER;
        _btnCustomer ctrlAddEventHandler["ButtonClick", {
            ["btnCustomerClicked", _this] call RscDisplayTaxiMenu
        }];
        private _btnSettings = _display displayCtrl MAV_IDC_RSCDISPLAYTAXIMENU_SETTINGS;
        _btnSettings ctrlAddEventHandler["ButtonClick", {
            ["btnSettingsClicked", _this] call RscDisplayTaxiMenu
        }];
        ...
        _params params[["_btnCtrl", controlNull, [controlNull]]];
