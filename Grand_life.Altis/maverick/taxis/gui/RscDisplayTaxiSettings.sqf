...
case "onLoad":
    {
        ...
        _customizeTaximeterPositionButton ctrlAddEventHandler["ButtonClick", {
            ["customizeTaximeter", _this] call RscDisplayTaxiSettings
        }];
        private _customizeTaximeterPositionResetButton = _display displayCtrl MAV_IDC_RSCDISPLAYTAXISETTINGS_TAXIMETER_RESET;
        _customizeTaximeterPositionResetButton ctrlAddEventHandler["ButtonClick", {
            ["resetTaximeter", _this] call RscDisplayTaxiSettings
        }];
