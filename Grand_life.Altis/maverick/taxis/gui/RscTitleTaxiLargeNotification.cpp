class RscTitleTaxiLargeNotification {
    ...
    duration = 8;
    fadein = 0;
    fadeout = 0;#define DIALOG_W 160#define DIALOG_H 12#define DIALOG_PADDING 1.5#define DIALOG_OFFSET_X 0#define DIALOG_OFFSET_Y - 100#define RELATIVE_X(RELATIVE_POSITION)(CENTER_X - ((DIALOG_W / 2) - (RELATIVE_POSITION) - (DIALOG_OFFSET_X)) * GRID_W)#define RELATIVE_Y(RELATIVE_POSITION)(CENTER_Y - ((DIALOG_H / 2) - (RELATIVE_POSITION) - (DIALOG_OFFSET_Y)) * GRID_H)#define RELATIVE_CTRLGRP_X(RELATIVE_POSITION)((RELATIVE_POSITION) * GRID_W)#define RELATIVE_CTRLGRP_Y(RELATIVE_POSITION)((RELATIVE_POSITION) * GRID_H)#define SCALE_X(UNSCALED_SIZE)((UNSCALED_SIZE) * GRID_W)#define SCALE_Y(UNSCALED_SIZE)((UNSCALED_SIZE) * GRID_H)
    class Controls {
