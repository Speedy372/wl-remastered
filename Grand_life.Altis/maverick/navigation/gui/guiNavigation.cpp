class MAV_guiNavigation {
    ...
    movingEnable = 0;
    class Controls {#define IMAGE_SIZE(SIZE_XL * 6)#define DIALOG_W 192#define DIALOG_H 52#define DIALOG_BORDER 2#define DIALOG_CONTENTW(DIALOG_W - (DIALOG_BORDER * 2))#define DIALOG_CONTENTH(DIALOG_H - ((SIZE_M + 1) + (DIALOG_BORDER * 2)))
...
class MAV_guiNavigationCurrent {
    ...
    movingEnable = 0;#define CONTENT_W 110#define CONTENT_H 70#define CONTENT_BORDER 2
    class controls {
        class Background: MAV_ctrlStaticBackground {
...
class MAV_guiNavigationNew {
    ...
    movingEnable = 0;#define CONTENT_W 150#define CONTENT_H 90#define CONTENT_BORDER 2
    class controls {
        class Background: MAV_ctrlStaticBackground {
            x = CENTER_X - (CONTENT_W / 2) * GRID_W;
            y = CENTER_Y - (CONTENT_H / 2) * GRID_H;
...
class MAV_guiNavigationSettings {
    ...
    movingEnable = 0;#define CONTENT_W 90#define CONTENT_H 60#define CONTENT_BORDER 2
    class controls {
        class Background: MAV_ctrlStaticBackground {
            x = CENTER_X - (CONTENT_W / 2) * GRID_W;
            y = CENTER_Y - (CONTENT_H / 2) * GRID_H;
...
class MAV_guiNavigationResize {
    ...
    duration = 10e+9;
    fadeIn = 0;
    fadeOut = 0;#define DIALOG_W 100#define DIALOG_H 60
...
class MAV_guiNavigationCalculateWO {
    ...
    onLoad = "['navigation\gui', 'MAV_guiNavigationCalculateWO', _this, true] call MAV_gui_fnc_openGUI";#define CONTENT_W 110#define CONTENT_H 70#define CONTENT_BORDER 2
    class Controls {
        class Background: MAV_ctrlStaticBackground {
            x = CENTER_X - (CONTENT_W / 2) * GRID_W;
            y = CENTER_Y - (CONTENT_H / 2) * GRID_H;
...
class MAV_guiNavigationCalculate {
    idd = MAV_IDD_GUINAVIGATIONCALCULATE;#define CONTENT_W 110#define CONTENT_H 70#define CONTENT_BORDER 2
    class Controls {
        class Background: MAV_ctrlStaticBackground {
            x = CENTER_X - (CONTENT_W / 2) * GRID_W;
            y = CENTER_Y - (CONTENT_H / 2) * GRID_H;
...
class MAV_guiNavigationSave {
    ...
    onLoad = "['navigation\gui', 'MAV_guiNavigationSave', _this, true] call MAV_gui_fnc_openGUI";#define CONTENT_W 80#define CONTENT_H 21#define CONTENT_BORDER 2
    class Controls {
        class Background: MAV_ctrlStaticBackground {
            x = CENTER_X - (CONTENT_W / 2) * GRID_W;
            y = CENTER_Y - (CONTENT_H / 2) * GRID_H;
