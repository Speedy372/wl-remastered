#define MAVFNC MAV_guiNavigation#define MAVCFG missionConfigFile >> "maverick_navigation_cfg"#define pixelScale 0.50#define GRID_W(pixelW * pixelGrid * pixelScale)#define GRID_H(pixelH * pixelGrid * pixelScale)#define SIZE_XL 6#define BORDER 2#define IMAGE_SIZE(SIZE_XL * 6)#include "maverick\navigation\gui\gui_includes.h"
