...
closeDialog 0;
_log = format["%1, %2 wystawil mandat %3 za %4", name player, getPlayerUID player, life_ticket_unit getVariable["realname", name life_ticket_unit], [(parseNumber _val)] call life_fnc_numberText];
[_log, "mandat"] remoteExecCall["A3Log", 2];