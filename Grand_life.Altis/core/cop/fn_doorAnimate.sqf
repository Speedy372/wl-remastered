...
private _target = [1, 0] select(((_b animationPhase format["door_%1a_move", _door]) isEqualTo 1) || ((_b animationPhase format["door_%1_rot", _door]) isEqualTo 1) || ((_b animationPhase format["door_%1a_rot", _door]) isEqualTo 1)); {
