#include "script_macros.hpp"#define Btn1 37450#define Btn2 37451#define Btn3 37452#define Btn4 37453#define Btn5 37454#define Btn6 37455#define Btn7 37456#define Btn8 37457#define Btn9 37458#define Title 37401
private["_display", "_curTarget", "_Btn1", "_Btn2", "_Btn3", "_Btn4", "_Btn5", "_Btn6", "_Btn7", "_Btn8", "_Btn9", "_dlcVehicles"];
if (!dialog) then {
...
if ((life_inv_toolkit >= 1) && {
    alive life_vInact_curTarget
} && {
    ([life_vInact_curTarget] call life_fnc_isDamaged)
}) then {
...
case west:
    {
        ...
        if (_curTarget isKindOf "Ship") then {
            ...
            if (alive _curTarget && _curTarget isKindOf "Ship" && {
                local _curTarget
            } && {
        ...
        _Btn9 ctrlSetText "Bagażnik";
        if ((_curTarget) in life_vehicles) then {
            _Btn9 buttonSetAction "closeDialog 0; [life_vInact_curTarget] spawn life_fnc_openInventory;";
        } else {
...
case civilian:
    {
        ...
        if (typeOf _curTarget == "O_Truck_03_device_F") then {
            ...
            if (!isNil {
                (_curTarget getVariable "mining")
            }
            OR ! local _curTarget && {
                _curTarget in life_vehicles
            }) then {
                _Btn4 ctrlEnable false;
            } else {
            ...
            if (typeOf(_curTarget) in ["C_Van_01_fuel_F", "I_Truck_02_fuel_F", "B_Truck_01_fuel_F"] && _curTarget in life_vehicles) then {
                if (!isNil {
                    _curTarget getVariable "fuelTankWork"
                }) then {
