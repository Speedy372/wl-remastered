#include "script_macros.hpp" [] call SOCK_fnc_updateRequest;
...
sleep 0.25;
_name = name player;
[format["<t size='1.3' color='#00C10D'>Dzięki za przybycie!</t><br/>Do zobaczenia %1 ! <br/><t size='1.1'>Gra Zapisana.</t>", _name], 0, 0.2, 10, 0, 0, 8] spawn BIS_fnc_dynamicText;
sleep 4;
