                ...
                case 605:
                    {
                        if (_ispack) then {
                            ...
                            if (_override) then {
                                ...
                                if (headgear player isEqualTo _item && { ! _preview
                                }) then {
                                    player addItem _item;
                                } else {
                        ...
                        if (_ispack) then {
                            ...
                            if (_override) then {
                                ...
                                if (player isKindOf "Civilian") then {
                                    if (uniform player isEqualTo _item && { ! _preview
                                    }) then {
                                        player addItem _item;
                                    } else {
                ...
                case 701:
                    {
                        if (_ispack) then {
                            ...
                            if (_override) then {
                                ...
                                if (vest player isEqualTo _item && { ! _preview
                                }) then {
                                    player addItem _item;
                                } else {
                        ...
                        if (_ispack) then {
                            ...
                            if (_ongun) then {
                                ...
                                if (_override) then {
                                    ...
                                    if (! ((_wepItems select 2) isEqualTo "")) then {
                                        _slotTaken = true;
                                    };
                                    if (_slotTaken) then {
                        ...
                        if (_ispack) then {
                            ...
                            if (_ongun) then {
                                ...
                                if (_override) then {
                                    ...
                                    if (! ((_wepItems select 1) isEqualTo "")) then {
                                        _slotTaken = true;
                                    };
                                    if (_slotTaken) then {
                                        _action = [localize "STR_MISC_AttachmentMSG", localize "STR_MISC_Attachment", localize "STR_MISC_Weapon", localize "STR_MISC_Inventory"] call BIS_fnc_guiMessage;
                        ...
                        if (_ispack) then {
                            ...
                            if (_ongun) then {
                                ...
                                if (_override) then {
                                    ...
                                    if (! ((_wepItems select 0) isEqualTo "")) then {
                                        _slotTaken = true;
                                    };
                                    if (_slotTaken) then {
                                        _action = [localize "STR_MISC_AttachmentMSG", localize "STR_MISC_Attachment", localize "STR_MISC_Weapon", localize "STR_MISC_Inventory"] call BIS_fnc_guiMessage;
    ...
    case "CfgWeapons":
        {
            ...
            if (_isgun) then {
                switch (true) do {
                case(primaryWeapon player isEqualTo _item):
                    {
                        _ispack = false;
                    };
                case(secondaryWeapon player isEqualTo _item):
                    {
                        _ispack = false;
                    };
                case(handgunWeapon player isEqualTo _item):
                    {
                        _ispack = false;
                    };
