...
private["_price", "_item", "_itemInfo", "_bad", "_text", "_text2"];
...
if ((_shop == "b_market") && !(_text == "Broń") && !(_text2 == "Broń")) then {
    ...
    private _hideoutObjs = [[["Altis", _altisArray], ["Malden", _altisArray], ["Tanoa", _tanoaArray]]] call TON_fnc_terrainSort;
    ...
    if (!isNil "_hideout" && { ! isNil {
        ...
        [format[(localize "STR_Shop_Virt_Gang_FundsMSG") + "<br/><br/>" + (localize "STR_Shop_Virt_Gang_Funds") + " <t color='#8cff9b'>$%1</t><br/>" + (localize "STR_Shop_Virt_YourFunds") + " <t color='#8cff9b'>$%2</t>", [(group player getVariable "gang_bank")] call life_fnc_numberText, [BTC] call life_fnc_numberText], localize "STR_Shop_Virt_YourorGang", localize "STR_Shop_Virt_UI_GangFunds", localize "STR_Shop_Virt_UI_YourCash"] spawn life_fnc_guiMsg;
