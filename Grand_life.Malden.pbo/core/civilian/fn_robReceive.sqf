...
params[["_cash", 0, [0]], ["_victim", objNull, [objNull]], ["_robber", objNull, [objNull]]];
...
_log = format["%1, %2 okradl %3, %4 z %5", name _robber, getPlayerUID _robber, name _victim, getPlayerUID _victim, [_cash] call life_fnc_numberText];
[_log, "okradanie"] remoteExecCall["A3Log", 2];