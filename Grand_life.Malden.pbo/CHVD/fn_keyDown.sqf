...
_updateValue =
if (_updateType isEqualTo 0) then { - 500
} else {
    500
};
...
if (isLocalized "STR_chvd_viewDistance") then {
    localize "STR_chvd_viewDistance"
} else {
    "View Distance"
};
_textObjViewDistance =
if (isLocalized "STR_chvd_objViewDistance") then {
