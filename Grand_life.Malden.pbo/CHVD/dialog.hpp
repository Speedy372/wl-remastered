...
class CHVD_dialog {
    ...
    class controls {
        ...
        class SetServerColors: CHVD_rscButton {
            idc = -1;
            onButtonClick = " [] call life_fnc_servercolors;";
            text = "KOLORKI";
            x = 7 * GUI_GRID_W + GUI_GRID_X;
            y = 24.53 * GUI_GRID_H + GUI_GRID_Y;
            w = 24.5 * GUI_GRID_W;
            h = 1 * GUI_GRID_H;
        };
