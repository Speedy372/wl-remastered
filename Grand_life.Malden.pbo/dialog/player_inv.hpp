...
class playerSettings {
    ...
    class controls {
        ...
        class ButtonSettings_ICON: life_RscPicture {
            idc = -1;
            text = "images\tablet\animation.paa";
        ...
        class Barrier_ICON: life_RscPicture {
            idc = 81204;
            text = "images\tablet\barrier.paa";
            x = 0.621372 * safezoneW + safezoneX;
            y = 0.6988 * safezoneH + safezoneY;
            w = 0.0315 * safezoneW;
            h = 0.056 * safezoneH;
        };
        class ButtonBarrier: life_RscButtonMenu {
            idc = 82001;
