...
class czorny_rynek_klamek {
    idd = 2400;
    name = "czorny_rynek_klamek";
    movingEnable = 0;
    enableSimulation = 1;
    onunload = "call life_fnc_btcupdate";
    class controlsBackground {
        class Life_RscTitleBackground: Life_RscText {
            colorBackground[] = {
                "(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])",
    ...
    class controls {
        ...
        class ButtonRemoveAllG: Life_RscButtonMenu {
            ...
            onButtonClick = "[] call Life_fnc_bm_sellAll;";
            x = 0.53 + (0.35 / 2) - ((6.25 / 40) / 2);
            y = 0.75;
            w = (6.25 / 40);
            h = (1 / 25);
        ...
        class ButtonRemoveG: Life_RscButtonMenu {
            ...
            onButtonClick = "[] call life_fnc_bm_sell";
            x = 0.53 + (0.35 / 2) - ((6.25 / 40) / 2);
            y = 0.70;
            w = (6.25 / 40);
            h = (1 / 25);
