class Life_impound_menu {
    ...
    movingEnable = 0;
    enableSimulation = 1;
    onLoad = "ctrlShow [2330,false]; [] spawn { if (count (attachedObjects player) > 0) then { uisleep 1; closeDialog 0; hint 'Masz już wyciągnięty pojazd' } } ;";
    ...
    class controls {
        ...
        class InsureCar: life_RscButtonMenu {
            ...
            x = 0.594464 * safezoneW + safezoneX;
            y = 0.72275 * safezoneH + safezoneY;
            w = 0.134062 * safezoneW;
            h = 0.03245 * safezoneH;
            tooltip = "Ubezpiecz";
