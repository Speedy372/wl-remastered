class Life_cell_phone {
    ...
    class controls {
        ...
        class CopPSA: Life_RscButtonMenu {
            idc = 3222;
            onButtonClick = "[] call TON_fnc_cell_coppsa";
            text = "$STR_CELL_CopPSA";
        ...
        class MedMSGALL: Life_RscButtonMenu {
            idc = 3222;
            onButtonClick = "[] call TON_fnc_cell_MedMSGALL";
            text = "$STR_CELL_CopPSA";
            x = 0.52575 * safezoneW + safezoneX;
            y = 0.4736 * safezoneH + safezoneY;
            w = 0.0825 * safezoneW;
            h = 0.022 * safezoneH;
            colorBackground[] = {
