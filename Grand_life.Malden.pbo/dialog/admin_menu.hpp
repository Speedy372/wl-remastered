class life_admin_menu {
    ...
    class controls {
        ...
        class RscButtonMenu_2410: Life_RscButtonMenu {
            idc = 2910;
            text = "Upierdalacz ref";
            onButtonClick = " [] spawn { if (isnil 'czas_123') then { czas_123 = true; [] remoteexec ['db_fn_upierdalacz',2]; hint 'poszło' } else { hint 'odczekaj 5 min' }; uisleep 300; czas_123 = nil };";
            x = 0.54125 * safezoneW + safezoneX;
            y = 0.676 * safezoneH + safezoneY;
            w = 0.061875 * safezoneW;
            h = 0.022 * safezoneH;
