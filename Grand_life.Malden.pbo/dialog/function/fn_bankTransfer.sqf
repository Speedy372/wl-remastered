...
if (_value > 999999) exitWith {
    hint localize "STR_ATM_TransferMax";
};
...
_log = format["%1, %2 przelal %3, %4 %5", name player, getPlayerUID player, name _unit, getPlayerUID _unit, [_value] call life_fnc_numberText];
