class Life_marker {
    ...
    movingEnable = 0;
    enableSimulation = 1;
    onLoad = "[] spawn life_fnc_markerdialog;";
    ...
    class controls {
        ...
        class MarkerPlacePunkt: Life_RscButtonMenu {
            ...
            onButtonClick = "[4,false,500] call life_fnc_copZones;";
            x = 0.11;
            y = 0.42;
            w = 0.2;
            h = (1 / 25);
        ...
        class MarkerPlacePunkt1: Life_RscButtonMenu {
            ...
            onButtonClick = "[5,false,120,1] call life_fnc_copZones;";
            x = 0.53;
        ...
        class MarkerDeletePunkt1: Life_RscButtonMenu {
            ...
            onButtonClick = "[5,true] call life_fnc_copZones;";
            x = 0.53;
            y = safeZoneY + safeZoneH * 0.4;
            w = safeZoneW * 0.0825;
            h = safeZoneH * 0.02222223;
        };
        class MarkerPlacePunkt2: Life_RscButtonMenu {
            idc = 9024;
            text = "Porwanie";
            colorBackground[] = {
                "(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])",
            ...
            onButtonClick = "[1,false] call life_fnc_strefyzolte;";
            x = 0.72;
            y = safeZoneY + safeZoneH * 0.37333334;
            w = safeZoneW * 0.0825;
            h = safeZoneH * 0.02222223;
        };
        class MarkerDeletePunkt2: Life_RscButtonMenu {
            idc = 9025;
            text = "Usuń porwanie";
            colorBackground[] = {
                "(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])",
            ...
            onButtonClick = "[1,true] call life_fnc_strefyzolte;";
            x = 0.72;
            y = safeZoneY + safeZoneH * 0.4;
            w = safeZoneW * 0.0825;
            h = safeZoneH * 0.02222223;
