#define DISPLAY_NAME CAU_UserInputMenus_displaySlider#include "cau\userinputmenus\systems\_defines.inc"
params[["_parameters", [], [[]]], ["_title", "", [""]], ["_formatVal", {},
[{}]], ["_code", {},
[{}]], ["_button1", "", [""]], ["_button2", 0, [""]], ["_parentDisplay", displayNull, [displayNull]]];
_parameters params[["_range", [0, 0], [[]], 2], ["_position", 0, [0]], ["_speed", [1, 1], [[]], 2]];
...
_ctrlInput setVariable["sliderPosChanged", {
    ...
    private _format = _ctrlTitle getVariable["format", {
        _position
    }];
...
_ctrlInput ctrlAddEventHandler["SliderPosChanged", {
    _this call((_this #0) getVariable["sliderPosChanged",{}])}];[_ctrlInput,_position]call(_ctrlInput getVariable["sliderPosChanged",{}]);
