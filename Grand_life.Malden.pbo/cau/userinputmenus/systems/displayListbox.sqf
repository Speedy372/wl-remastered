#define DISPLAY_NAME CAU_UserInputMenus_displayListbox#include "cau\userinputmenus\systems\_defines.inc"
params[["_parameters", [], [[]]], ["_title", "", [""]], ["_code", {},
[{}]], ["_button1", "", [""]], ["_button2", 0, [""]], ["_parentDisplay", displayNull, [displayNull]]];
_parameters params[["_items", [], [[]]], ["_startIndex", 0, [0]], ["_multiSel", false, [true]]];
...
},
{
    ...
    if ! _confirmed then {
        for "_i"
        from 0 to(lbSize _ctrlInput - 1) do {
            _ctrlInput lbSetSelected[_i, false];
        };
    };
    private _index = lbSelection _ctrlInput;
    private _data = _index apply {
        _ctrlInput lbData _x
    };
    private _value = _index apply {
        _ctrlInput lbValue _x
    };
    _display closeDisplay 2;
    _code call {
        private["_display", "_ctrlInput", "_code"];
...
}] select _multiSel;#include "cau\userinputmenus\systems\_common.inc"
lbClear _ctrlInput; {
    _x params[["_textLData", [], [[]]], ["_textRData", [], [[]]], ["_iconLData", [], [[]]], ["_iconRData", [], [[]]], ["_tooltip", "", [""]], ["_data", "", [""]], ["_value", -1, [0]]];
...
if _multiSel then {
    _ctrlInput lbSetSelected[_index, true]
};