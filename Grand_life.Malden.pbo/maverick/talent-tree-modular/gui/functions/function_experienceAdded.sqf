scriptName "function_experienceAdded";#define __filename "function_experienceAdded.sqf"#define TIME_PER_PERCENT 0.06
try {
    disableSerialization;
    params[["_data", [], [[]]], ["_message", "", [""]]]; {
        ...
        if (isNull _topConfig) then {} else {
            ...
            "TTM_GUI_RscTitleExperienceAdded"
            cutRsc["TTM_GUI_RscTitleExperienceAdded", "PLAIN"];
