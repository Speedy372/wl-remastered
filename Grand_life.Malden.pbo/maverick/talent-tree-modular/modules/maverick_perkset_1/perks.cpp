...
class perk_gunsspecialist_NoWeaponSway_1 {
    displayName = "NoWeaponSway";
    requiredPerkPoints = 5;
    requiredLevel = 5;
    requiredPerk = "";
    subtitle = "Level 5 Required, 5 Perk Points";
    description = "Set aim precision coefficient for weapon sway<br/><br/><t color='#10FF45'>-5% less recoil</t>";
    initScript = "maverick\talent-tree-modular\modules\maverick_perkset_1\functions\functions_NoWeaponSway_1.sqf";
    limitToSides[] = {};
    color[] = {
        1,
        1,
...
class perk_gunsspecialist_NoWeaponSway_2 {
    displayName = "NoWeaponSway 2";
    requiredPerkPoints = 6;
    requiredLevel = 16;
    requiredPerk = "perk_gunsspecialist_NoWeaponSway_1";
    subtitle = "Level 16 Required, 6 Perk Points";
    description = "Set aim precision coefficient for weapon sway<br/><br/><t color='#10FF45'>-10% less recoil</t>";
    initScript = "maverick\talent-tree-modular\modules\maverick_perkset_1\functions\functions_NoWeaponSway_2.sqf";
    limitToSides[] = {};
    color[] = {
        1,
        1,
...
class perk_gunsspecialist_NoWeaponSway_3 {
    displayName = "NoWeaponSway 3";
    requiredPerkPoints = 7;
    requiredLevel = 25;
    requiredPerk = "perk_gunsspecialist_NoWeaponSway_2";
    subtitle = "Level 25 Required, 7 Perk Points";
    description = "Set aim precision coefficient for weapon sway<br/><br/><t color='#10FF45'>-20% less recoil</t>";
    initScript = "maverick\talent-tree-modular\modules\maverick_perkset_1\functions\functions_NoWeaponSway_2.sqf";
    limitToSides[] = {};
    color[] = {
        1,
...
class perk_repair_1 {
    ...
    requiredPerk = "";
    subtitle = "Level 7 Required, 5 Perk Points";
    description = "Learn to pick locks more efficiently and reduce repairing times on vehicles<br/><br/><t color='#10FF45'>+10% faster repairing</t>";
...
class perk_repair_2 {
    ...
    subtitle = "Level 16 Required, 6 Perk Points";
    description = "Learn to pick locks more efficiently and reduce repairing times on vehicles<br/><br/><t color='#10FF45'>+15% faster repairing</t>";
...
class perk_repair_3 {
    ...
    subtitle = "Level 28 Required, 4 Perk Points";
    description = "Learn to pick locks more efficiently and reduce repairing times on vehicles<br/><br/><t color='#10FF45'>+25% faster repairing</t>";
