scriptName "fn_updateDatabaseEntry";#define __filename "fn_updateDatabaseEntry.sqf"
scopeName "main";
diag_log "fn_updateDatabaseEntry.sqf 1";
params[["_which", -1, [0]], ["_toUpdate", [], [0, []]], ["_pid", "", [""]]];
diag_log "fn_updateDatabaseEntry.sqf 2";
if (_toUpdate isEqualTo[] || {
    _pid isEqualTo ""
} || {
    _which isEqualTo - 1
}) exitWith {};
...
case 3:
    {
        if (_toUpdate isEqualType 0) then {
            breakOut "main"
        };
