...
class MAV_ctrlMapEmpty: MAV_ctrlMap {
    ...
    class Task: Task {
        ...
        size = 0;
    };#define EMPTY_ICON(CLASSNAME) class CLASSNAME: CLASSNAME {
        icon = "#(argb,8,8,3)color(0,0,0,0)";
        color[] = {
            0,
            0,
    ...
    EMPTY_ICON(Waypoint) EMPTY_ICON(WaypointCompleted) EMPTY_ICON(CustomMark) EMPTY_ICON(Command) EMPTY_ICON(Bush) EMPTY_ICON(Rock) EMPTY_ICON(SmallTree) EMPTY_ICON(Tree) EMPTY_ICON(busstop) EMPTY_ICON(fuelstation) EMPTY_ICON(hospital) EMPTY_ICON(church) EMPTY_ICON(lighthouse) EMPTY_ICON(power) EMPTY_ICON(powersolar) EMPTY_ICON(powerwave) EMPTY_ICON(powerwind) EMPTY_ICON(quay) EMPTY_ICON(shipwreck) EMPTY_ICON(transmitter) EMPTY_ICON(watertower) EMPTY_ICON(Bunker) EMPTY_ICON(Cross) EMPTY_ICON(Fortress) EMPTY_ICON(Fountain) EMPTY_ICON(Chapel) EMPTY_ICON(Ruin) EMPTY_ICON(Stack) EMPTY_ICON(Tourism) EMPTY_ICON(ViewTower)
};