class RscDisplayTaxiCall {
    ...
    class Controls {
        ...
        class CallTaxiButton: MAV_ctrlButton {#define BUTTON_HEIGHT 5#define BUTTON_WIDTH 50
        ...
        class CancelTaxiButton: MAV_ctrlButton {#define BUTTON_HEIGHT 5#define BUTTON_WIDTH 50
