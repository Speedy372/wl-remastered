class RscDisplayTaxiCalls {
    ...
    onLoad = "['taxis\gui', 'RscDisplayTaxiCalls', _this, true, 'RscDisplayTaxiCalls'] call MAV_gui_fnc_openGUI";#define DIALOG_W 150#define DIALOG_H 70#define DIALOG_PADDING 1.5#define DIALOG_OFFSET_X 0#define DIALOG_OFFSET_Y 0#define RELATIVE_X(RELATIVE_POSITION)(CENTER_X - ((DIALOG_W / 2) - (RELATIVE_POSITION) - (DIALOG_OFFSET_X)) * GRID_W)#define RELATIVE_Y(RELATIVE_POSITION)(CENTER_Y - ((DIALOG_H / 2) - (RELATIVE_POSITION) - (DIALOG_OFFSET_Y)) * GRID_H)#define SCALE_X(UNSCALED_SIZE)((UNSCALED_SIZE) * GRID_W)#define SCALE_Y(UNSCALED_SIZE)((UNSCALED_SIZE) * GRID_H)
    ...
    class Controls {
        ...
        class Footer: MAV_ctrlStaticFooter {#define FOOTER_HEIGHT 8
            x = RELATIVE_X(0);
            y = RELATIVE_Y(DIALOG_H - FOOTER_HEIGHT);
            w = SCALE_X(DIALOG_W);
            h = SCALE_Y(FOOTER_HEIGHT);
        };
        class CloseDialog: MAV_ctrlButton {#define BUTTON_HEIGHT 5#define BUTTON_WIDTH 30
            x = RELATIVE_X(DIALOG_PADDING);
        ...
        class RefreshButton: MAV_ctrlButton {#define BUTTON_HEIGHT 5#define BUTTON_WIDTH 30
        ...
        class AcceptButton: MAV_ctrlButton {#define BUTTON_HEIGHT 5#define BUTTON_WIDTH 40
        ...
        class CancelButton: MAV_ctrlButton {#define BUTTON_HEIGHT 5#define BUTTON_WIDTH 40
        ...
        class GoOnDutyButton: MAV_ctrlButton {#define BUTTON_HEIGHT 5
        ...
        class GoOffDutyButton: MAV_ctrlButton {#define BUTTON_HEIGHT 5
