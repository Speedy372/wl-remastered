params["_startPos", "_wayPoints", "_preference"];
private _return = [];
for "_y"
from 0 to 1 step 0 do {
    ...
    if (! ((toLower(worldName) find "altis") isEqualTo - 1)) then {
        if ((_startPos inArea[[7737.795, 14336.498, 0], 6745.936, 10345.594, 0, true]) && {
            _endPos inArea[[20041.074, 9653.373, 0], 5428.237, 5627.76, 0, true]
        }) then {
