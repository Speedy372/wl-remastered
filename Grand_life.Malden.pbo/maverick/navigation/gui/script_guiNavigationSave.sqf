#define MAVFNC MAV_guiNavigationSave#define MAVCFG missionConfigFile >> "maverick_navigation_cfg"#include "maverick\navigation\gui\gui_includes.h"
...
case "onLoad":
    {
        ...
        _edit ctrlAddEventHandler["KeyUp", {
            ["onKeyUp", _this] call MAVFNC
        }];
        _edit ctrlAddEventHandler["MouseEnter", {
            ["onMouseEnter", _this] call MAVFNC
        }];
    }; case "onKeyUp": {
...
case "saveRoute":
    {
        ...
        count toArray _text > 0) exitWith {
        ...
        profileNamespace setVariable[format["MAV_gps_saved_%1_%2", _world, _savedLocation], [_text, MAV_guiNavigationCalculate_Waypoint, MAV_guiNavigationCalculate_Route apply {
            getPos _x
        },
        mav_gps_v_currentRouteSearchType]];
