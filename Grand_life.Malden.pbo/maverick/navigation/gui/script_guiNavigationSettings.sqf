#define MAVFNC MAV_guiNavigationSettings#define MAVCFG missionConfigFile >> "maverick_navigation_cfg"#include "maverick\navigation\gui\gui_includes.h"
...
case "onLoad":
    {
        ...
        _customize ctrlAddEventHandler["ButtonClick", {
            ["customize", _this] call MAVFNC
        }];
        ...
        _redSlider ctrlAddEventHandler["SliderPosChanged", {
            ["redSlider", _this] call MAVFNC
        }];
        ...
        _greenSlider ctrlAddEventHandler["SliderPosChanged", {
            ["greenSlider", _this] call MAVFNC
        }];
        ...
        _blueSlider ctrlAddEventHandler["SliderPosChanged", {
            ["blueSlider", _this] call MAVFNC
        }];
        private _distance = _display displayCtrl MAV_IDC_GUINAVIGATIONSETTINGS_DISTANCE;
        _distance ctrlAddEventHandler["LBSelChanged", {
            ["distanceChanged", _this] call MAVFNC
        }];
        ...
        _path ctrlAddEventHandler["LBSelChanged", {
            ["pathChanged", _this] call MAVFNC
        }];
        private _pathCount = {
        ...
        _save ctrlAddEventHandler["ButtonClick", {
            ["saveSettings", _this] call MAVFNC
        }];
        private _voiceSetting = _display displayCtrl MAV_IDC_GUINAVIGATIONSETTINGS_VOICE;
        _voiceSetting ctrlAddEventHandler["LBSelChanged", {
            ["voiceChanged", _this] call MAVFNC
        }];
        _voiceSetting lbAdd "Disabled";
        _voiceSetting lbSetData[(lbSize _voiceSetting) - 1, "disabled"];
        private _allVoiceConfigs = "true"
        configClasses(missionConfigFile >> "maverick_navigation_cfg" >> "soundInstructions");
...
case "saveSettings":
    {
        ...
        count[["color", MAVV(color)], ["path", MAVV(path)], ["distance", MAVV(distance)]];
...
case "redSlider":
    {
        _params params[["_ctrl", controlNull, [controlNull]], ["_pos", -1, [0]]];
