#define MAVFNC MAV_guiNavigationCurrent#define MAVCFG missionConfigFile >> "maverick_navigationcfg"#include "maverick\navigation\gui\gui_includes.h"
...
case "onLoad":
    {
        ...
        _resetBtn ctrlAddEventHandler["ButtonClick", {
            ["resetRoute", _this] spawn MAVFNC
        }];
        ...
        private _ret = [(getText(missionConfigFile >> "maverick_navigation_cfg" >> "localization" >> "msgCancelConfirm")), (getText(missionConfigFile >> "maverick_navigation_cfg" >> "localization" >> "msgCancelRoute")), (getText(missionConfigFile >> "maverick_navigation_cfg" >> "localization" >> "msgProceed")), (getText(missionConfigFile >> "maverick_navigation_cfg" >> "localization" >> "msgCancel"))] call BIS_fnc_guiMessage;
        if (_ret) then {
