...
private _hideoutObjs = ["Land_ConcreteWell_02_F"];
...
[[0, 1], "Policja zajęła kryjówkę gangu !"] remoteExecCall["life_fnc_broadcast", RCLIENT];
_hideout setVariable["inCapture", false, true];
_name = _ownGroup getVariable["gang_name", "NIEPRZEJETA"];
_hideout setVariable["gangOwner", -1, true];
_hideout setVariable["gangOwnerName", "Brak", true];
